...
import { errorClass, errorElement, hidden, position, reportUrl, successClass, successElement } from '../../constants-bizert';
...
@Component({
  selector: 'app-user-bizert',
  templateUrl: './user-bizert.component.html',
  styleUrls: ['./user-bizert.component.scss']
})
export class UserBizertComponent {
   ...
   async embedReport(): Promise<void> {
     ...
     if(reportConfigResponse != undefined)
     this.reportConfig = {
       ...this.reportConfig,
